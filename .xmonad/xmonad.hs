...
myFont = "xft:xos4 terminus:pixelsize=24"
myBigFont   = "xft:xos4 terminus:pixelsize=32"
...
myStartupHook = do
    ...
    -- spawnOnce "$HOME/.bin/init-xmobars"
    -- spawn "/home/ethan/.bin/init-tilingwm"
    spawn "$HOME/.bin/init-wallpaper"
